      ...
      <div className="w-full max-w-md">
        ...
        >
          <div className="text-center">
            ...
            >
              Access your CeiTCS BuildBook dashboard
            </motion.p>
          </div>
          ...
          >
            ...
            <div>
              <button
                type="submit"
                disabled={isLoading}
                className="relative w-full btn btn-primary group"
              >
                <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                  <svg className="w-5 h-5 text-primary-500 group-hover:text-primary-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            ...
            <div className="text-sm text-center">
              ...
              <Link to="/register" className="ml-1 font-medium text-primary-600 hover:text-primary-800">
                Sign up now
              </Link>
            </div>
          </motion.form>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 mt-6">
              ...
              <button
                ...
                className="inline-flex justify-center w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
              >
                <svg className="w-5 h-5 mr-2 text-[#24292F]" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
